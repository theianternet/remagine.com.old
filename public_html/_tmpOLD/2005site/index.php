<?      require_once 'includes/remagine_defines.php';
        ob_start();
?>
...
<META NAME="KEYWORDS" CONTENT="www.remagine.com, www.remagine.net, www.remagine.org, remagine, marketing, website, design, hosting, advertising, graphics, springfield, public relations, business, internet, web, art, linux, microsoft, windows, massachusetts, internet">
<META Name="Author" Content="Ian Ricci">
<LINK rel="shortcut icon" href="images/favicon.ico" >
<LINK href="includes/remagineStyle.css" type=text/css rel=stylesheet>
...
<BODY leftmargin="0" TOPMARGIN="0" MARGINWIDTH="0" MARGINHEIGHT="0" onLoad="MM_preloadImages('../images/services2.jpg','../images/mission2.jpg','../images/support2.jpg','../images/aboutus2.jpg','../images/showcase2.jpg','../images/contactus2.jpg')">
<TABLE WIDTH=760 BORDER=0 CELLPADDING=0 CELLSPACING=0>
  <TR> 
    <TD COLSPAN=5> <a href="http://www.remagine.com"><IMG SRC="images/REMAGINE.jpg" ALT="REMAGINE" WIDTH=296 HEIGHT=63 border="0"></a></TD>
    <TD WIDTH=464 HEIGHT=63 COLSPAN=6 background="images/testremagine_03.jpg" valign="top"><div align="right" class="style2"><? echo date ("F j, Y"); ?>&nbsp;&nbsp;</div></TD>
  ...
  <TR> 
    ...
    <TD width="85"> <a href="index.php?section=support" onMouseOut="MM_swapImgRestore()" onMouseOver="MM_swapImage('Support','','images/support2.jpg',1)"><img src="images/support<? if ($section=="support") echo "2"?>.jpg" alt="Support" name="Support" width="85" height="19" border="0"></a></TD>
  ...
  <TR> 
    <TD COLSPAN=2><IMG SRC="<? if ($section=="home") 
				...
				elseif ($section=="contact")							 
			        ...
			        echo "images/business.jpg";
                                elseif ($section=="press")
                                echo "images/business.jpg";
                               ?>" width="179" height="99" ALT="REMAGINE"> </TD>
    <TD COLSPAN=8><IMG SRC="<? if ($section=="home") 
				...
				elseif ($section=="showcase")
			        echo "images/clientsbanner.jpg";
			        elseif ($section=="support")
				echo "images/romanaqueduct.jpg"; 
                                elseif ($section=="press")
                                echo "images/REMAGINE_col_press_and_events.jpg";
                                ?>" width="541" height="99" ALT="REMAGINE Banner" /> </TD>
    <TD width="40" valign="top"><IMG SRC="images/testremagine_14.jpg" WIDTH=40 HEIGHT=99 ALT=""></TD>
    <TD> <IMG SRC="images/spacer.gif" WIDTH=1 HEIGHT=99 ALT="REMAGINE spacer"></TD>
  </TR>
  <TR> 
    <TD width="178"> <IMG SRC="images/testremagine_15.jpg" WIDTH="178" HEIGHT="51" ALT="Login"></TD>
    <TD COLSPAN=10> <IMG SRC="<? if ($section=="home") 
	                          echo "images/testremagine_16.jpg";
                                  elseif ($section=="mission")
                                  echo "images/missionbar.jpg";		
				  elseif ($section=="support")
                                  echo "images/supportbar.jpg";							  		  
                                  elseif ($section=="services")
				  ...
				  elseif ($section=="showcase")
			          echo "images/clientsandaff.jpg"; 
                                  elseif ($section=="press")
                                  echo "images/REMAGINE_press_and_events.jpg";
                                  ?>" WIDTH="582" HEIGHT="51" ALT="REMAGINE menu"></TD>
    <TD> <IMG SRC="images/spacer.gif" WIDTH="1" HEIGHT="51" ALT="Spacer"></TD>
  </TR>
  <TR> 
...
<table width="20" border="0" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td height="20"><div align="center"> 
        <input class="loginbox" onFocus="{this.style.margin = '0'; this.style.borderColor = '#255e8b'; this.style.borderWidth = '2px'; this.style.backgroundColor = '#FFFFFF';}" onblur="{this.style.margin = '1px'; this.style.borderColor = '#999999'; this.style.borderWidth = '1px'; this.style.backgroundColor = '#eeeeee';}" name="login_username" id="log" value="" maxlength="255" size="25" type="text" autocomplete="off">
                </td>
  </tr>
  <tr>
  <td></td>
  ...
  <tr>
    <td height="20"><input class="loginbox" onFocus="{this.style.margin = '0'; this.style.borderColor = '#255e8b'; this.style.borderWidth = '2px'; this.style.backgroundColor = '#FFFFFF';}" onblur="{this.style.margin = '1px'; this.style.borderColor = '#999999'; this.style.borderWidth = '1px'; this.style.backgroundColor = '#eeeeee';}" name="secretkey" id="pass" value="" maxlength="255" size="25" type="password" autocomplete="off">
                </td>
  </tr>
  <tr>
  <td><br/>
  ...
  <tr>
    <td height="20"><input name="search" type="image" id="search" src="images/submit.gif" align="left"/></td>
  </tr>
</table>
</form>
          </td>
      ...
      <br/>
      <IMG SRC="images/testremagine_20.jpg" WIDTH=178 HEIGHT=3 ALT="">
    </TD>
    <TD COLSPAN=2 ROWSPAN=3 background="images/leftbar.jpg">&nbsp; </TD>
    <TD COLSPAN=8 ROWSPAN=3 valign="top"><? include $site[$section][$page];?></TD>
    <TD> <IMG SRC="images/spacer.gif" WIDTH="1" HEIGHT="104" ALT="REMAGINE spacer" /></TD>
  </TR>
  <TR> 
    <TD valign="top"></TD>
...
<br>Copyright &copy; <? echo date ("Y"); ?> <a href="http://www.remagine.com">REMAGINE</a>, all rights reserved.
</BODY>
</HTML>
