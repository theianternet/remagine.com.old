        ...
        <tr>
          <td width="145"> 
            <FORM style="DISPLAY: inline" action="/webmail/src/redirect.php" method="post">
			  ...
			  <div align="center"> 
                <input class="sp2_field" name="login_username" id="log" value="" maxlength="255" size="25" type="text">
                <br>
                <div align="left">Password:</div>
                <input class="sp2_field" name="secretkey" id="pass" value="" maxlength="255" size="25" type="password">
                <br>
                <br>
                <input name="search" type="image" id="search" src="images/submit.gif" align="left"/>
              </div>
            </form>
          </td>
        </tr>
...
</TABLE><br>Copyright &copy; <? echo date ("Y"); ?> <a href="http://www.remagine.com">REMAGINE</a>, all rights reserved.
</BODY>
</HTML>
