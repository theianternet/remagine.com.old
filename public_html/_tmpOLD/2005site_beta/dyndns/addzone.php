...
// Displays Add New Zone form.
echo '<b>Add New Zone</b><br><br>
<form name="form1" method="post" action="addzone.php">
Enter Domain Name: www.<input name="addzone" type="text" size="10">
...
echo "<br><bR>dfsdf";
// Future Condition.
//	die(if(mysql_errno() == 1062){
//		echo 'Sorry but this zone is in here fucker';
//	}
//);
