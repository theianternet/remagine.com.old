...
if(isset($_POST['send']))
{
    ...
    $reason = $_POST['reason'];
    $img_cap = new Securimage();
    $valid_cap = $img_cap->check($_POST['code']);
    $code = $_POST['code'];
...
if(trim($sname) == '')
    ...
    else if(trim($message) == '')
    {
      ...
      else if($valid_cap != true)
    {
        $errmsg = 'Please enter the correct security image code';
    }
    else if($valid_cap == true) {
    echo '<div align="left" class="body_text"><br />Your message has been sent.<br><strong>Your submission will be responded to within 24 hours. For immediate contact, please contact:</strong><br><br>
 <a href="mailto:support@remagine.net">info@remagine.com</a> <strong><br>888.571.0050 </strong><br><br />';}
...
<form  method="post" name="msgform" id="msgform"><center>
  <table width="600" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#FFFFFF" class="maincell">
    ...
    <tr bgcolor="#FFFFFF">
      <td align="left" valign="top"><div class="body_text">Security Image: </div></td>
      <td align="left">

<img src="../captcha/securimage_show.php?sid=<?php echo md5(uniqid(time())); ?>" id="image" align="absmiddle" />

<a href="#" onclick="document.getElementById('image').src = '../captcha/securimage_show.php?sid=' + Math.random(); return false"><br/><img src='/images/refresh.gif' alt='Reload Image' border='no'/>Refresh Image</a><br/>
<font color="#cc0000">*</font>&nbsp;<input type="text" name="code" /><br />
</td>
</tr>
    <tr bgcolor="#FFFFFF"> 
      <td>&nbsp;</td>
