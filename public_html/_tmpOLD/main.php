...
<META NAME="DESCRIPTION" CONTENT="REMAGINE is a full service firm that specializes in telecommunications solutions, data management, software development, web design, marketing, seo, and Internet technologies." />
<META NAME="KEYWORDS" CONTENT="remagine, marketing, web design, hosting, data management, website design springfield massachusetts, springfield, internet solutions, telecommunications solutions, seo, massachusetts" />
<META Name="Author" Content="REMAGINE LLC">
...
<link href="includes/remagineStyle2009.css" rel="stylesheet" type="text/css" />
...
<script type="text/javascript">
try {
var pageTracker = _gat._getTracker("UA-8564396-1");
pageTracker._trackPageview();
	...
	<body bgcolor="#ffffff" leftmargin="0" topmargin="0" marginheight="0" marginwidth="0">
		...
		<div id="Table_01" class="ts-1">
			...
			<div class="ts-1-16"><div class="contactnav"><a href="main.php?section=contact"><img height="36" alt="" src="images/contact<? if ($section=="contact") echo "2"?>.jpg" width="340" border="0"></a></div></div>
			...
			<div align="center" style="margin-bottom:0px;"><br>Copyright &copy; <? echo date ("Y"); ?> <a href="http://www.remagine.com">REMAGINE, REMAGINE, LLC</a>, all rights reserved.<br />
REMAGINE &reg; is a trademark of REMAGINE, LLC. 
</div>
			</div>
			<div class="ts-1-21"><img height="2" alt="" src="images/spacer.gif" width="1"></div>
			<div class="ts-1-22"><div class="showcasenav"><a href="main.php?section=affiliates"><img height="38" alt="" src="images/affiliates<? if ($section=="affiliates") echo "2"?>.jpg" width="340" border="0"></a></div></div>
			<div class="ts-1-23"><img height="38" alt="" src="images/spacer.gif" width="1"></div>
			<div class="ts-1-24"><img height="55" alt="" src="images/regcloud.jpg" width="340" border="0"></div>
